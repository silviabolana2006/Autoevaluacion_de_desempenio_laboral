...
class EvaluacionEmpleado:
    ...
    def __init__(self, id_empleado=None, nombre_empleado="Desconocido"):
        ...
        self.puntajes_individuales = [] # Lista de puntajes para cada criterio
    ...
    def set_resultados_inferencia(self, puntaje_final, puntajes_individuales, explicacion):
        """
        Establece los resultados obtenidos del motor de inferencia.
        """
        self.puntaje_final = puntaje_final
        self.puntajes_individuales = puntajes_individuales
